	...
	private void initialize() {
		...
		/*btnClienteBuscar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				fachada.buscarClientePorCpf(textFieldClienteBuscarCPF.getText());
		...
		textAreaServicoListaServicos.setBounds(0, 0, 455, 302);
		...
		btnRealizarReserva.setBounds(305, 42, 135, 39);
		...
		/*btnRealizarReserva.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				reserva.setInicioReserva(textFieldReservaDataEntrada.);
			}
		});*/
		...
		textAreaReservaListaFeitas.setBounds(10, 11, 430, 252);
